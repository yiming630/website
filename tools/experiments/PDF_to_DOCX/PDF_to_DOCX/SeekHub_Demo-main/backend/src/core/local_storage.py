...
class LocalFileStorage:
    ...
    def __init__(self):
        # 配置存储根目录
        self.storage_root = os.getenv('LOCAL_STORAGE_ROOT', 'C:/Users/Lenovo/Desktop/seekhub-demo/storage')
        self.public_url_base = os.getenv('PUBLIC_URL_BASE', 'http://localhost:4000/files')
